...
opnsense_kea_dhcpv4_lease_expiration | Gauge | client_id, hostname, if, interface_description, interface_name, ip_address, mac | Kea DHCPv4 | Lease's expiration in Unix time formatted in seconds | --exporter.disable-kea-dhcpv4 |
